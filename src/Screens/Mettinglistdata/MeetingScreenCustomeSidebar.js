...
import MeetingsListData from '../Mettinglistdata/MeetingsListData';
...
function firstScreenStack({ navigation }) {
  return (
    <Stack.Navigator initialRouteName="MeetingsListData">
      <Stack.Screen
        name="MeetingsListData"
        component={MeetingsListData}
        options={{
