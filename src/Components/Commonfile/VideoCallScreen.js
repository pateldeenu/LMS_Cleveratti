...
import { View, Text, Image, TouchableOpacity, StatusBar, KeyboardAvoidingView, FlatList, ScrollView, ImageBackground } from 'react-native';
            ...
            <View style={Styles.flexrowtextimage}>
                <View style={Styles.setfourimgcenterview}>
                    ...
                    <View>
                        ...
                        <Text style={Styles.namestyleset}>Smriti</Text>
                    </View>
                    <View>
                        <View style={Styles.twoimagewisth}>
                            <TouchableOpacity>
                        ...
                        <Text style={Styles.namestyleset}>Mahesh</Text>
                    </View>
                    <View>
                        <View style={Styles.twoimagewisth}>
                            <TouchableOpacity>
                        ...
                        <Text style={Styles.namestyleset}>Prinkesh</Text>
                    </View>
                </View>
            </View>
